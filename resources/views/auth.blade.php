                                ...
                                <div class="w-full pt-3 sm:pt-5 lg:pt-0 justify-center flex">
                                    <div class="mt-4 flex rounded-md shadow-sm sm:max-w-md w-full justify-center" style="flex-wrap: wrap">
                                        <div class="w-full flex justify-center">
                                            <form class="flex flex-wrap justify-end" method="post" action="{{ route('auth.login') }}" style="flex-wrap: wrap; width: 100%;">
                                                @csrf
                                                ...
                                                <div class="w-full flex justify-end">
                                                    <button type="submit"
                                                            style="font-weight: bold; padding: 5px 10px; background-color: #FF2D20; color: white; border-radius: 5px">
                                                        Wybierz
                                                    </button>
                                                </div>
