...
Route::post('/{session}', [LotteryController::class, 'store'])->name('session.member.store');
Route::delete('/{session}/{member}', [LotteryController::class, 'destroy'])->name('session.member.destroy');
